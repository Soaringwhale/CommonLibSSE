...
namespace RE
{
	...
	public:
		...
		virtual bool                        not_actor() const;                                                                                                                   // 06
		virtual void                        InitializeAnimationGraphVariables(const BSTSmartPointer<BShkbAnimationGraph>& animGraph);                                            // 07
		...
		virtual void                        DoFailedToLoadGraph() const;                                                                                                         // 09
		...
		virtual void                        ModifyInitialAnimationStateImpl();                                                                                                   // 0C
		...
		virtual bool                        ShouldUpdateAnimation() const;                                                                                                       // 0E
