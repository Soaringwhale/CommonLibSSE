...
namespace RE
{
	...
	public:
		...
		NiPoint3                                       movementRotation;            // 0B0
		NiPoint3                                       rotationSpeed;               // 0BC
		NiPoint3                                       horseMountEntryPosition;     // 0C8
		NiPoint3                                       furnitureEntryPosition;      // 0D4
		...
		void*                                          animationLoadedCallback;     // 1F0
		...
		void*                                          animationSetCallback;        // 230 - smart ptr
		...
		float                                          staggerTime;                 // 2DC
		std::uint32_t                                  unk2E0;                      // 2E0
		std::uint32_t                                  some_marker;                 // 2E4
		std::uint32_t                                  furnitureIndex;              // 2E8
		...
		stl::enumeration<RESET_3D_FLAGS, std::uint8_t> reset3dFlags;                // 311
