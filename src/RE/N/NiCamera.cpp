...
namespace RE
{
	...
	bool NiCamera::WorldPtToScreenPt3(const NiPoint3& point, float& xOut, float& yOut, float& zOut, float zeroTolerance) const
	{
		return WorldPtToScreenPt3(worldToCam, port, point, xOut, yOut, zOut, zeroTolerance);
	}
}
